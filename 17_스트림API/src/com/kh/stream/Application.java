...
public class Application {
	 ...
	 *    내부 반복자를 사용해서 병렬 처리(멀티 스레드 활용), 중간 처리, 최종 처리 작업을 수행할 수 있다는 점에서 차이가 있다. 
	 ...
	 *  	- 반환 값(리턴 타입)을 보면 쉽게 구분이 가능하다.
	 *  	- 리턴 타입이 Stream이라면 중간 처리 메소드이고, -> 메소드들을 스트림 파이프라인 이용 가능.
	 *  	- 리턴 타입이 기본 타입이거나 void, OptionalXXX 이면 최종 처리 메소드이다.
	 */
