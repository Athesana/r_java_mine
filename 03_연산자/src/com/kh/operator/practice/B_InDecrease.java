...
public class B_InDecrease {
	 ...
	 *  - ++ : 피연산자의 값을 1 증가시키는 연산자 (++값; or 값++;) 
	 *  - -- : 피연산자의 값을 1 감소시키는 연산자 (--값; or 값--;)
	 *  
	...
	public void method1() {
		...
		// 전위 연산자 테스트
		System.out.println("전위 연산자 적용 전 num의 값 : " + num);
		System.out.println("1회 수행 후 값 : " + ++num);	// 11, num = num + 1과 같은 결과를 만들어 낸다.
		...
		System.out.println("1회 수행 후 값 : " + num++); // + 는 문자열 연결 연산자 -> 먼저 수행 후 -> 1이 증가 된다. 13 출력
		System.out.println("2회 수행 후 값 : " + num++); // 14값으로 출력 된 상태로 문자열 연결되는게 먼저 연산되고 나서 15 값이 됨
		System.out.println("3회 수행 후 값 : " + num++); // 앞에서 15가 된 거를 출력하고 먼저 문자열 연결 연산하고 나서 16이 됨
	...
	public void method2() {
		...
		int num = 20;
		int result = num++ * 3; // 20 * 3 = 60, 60이라는 값이 result에 대입되고, num은 20 + 1 = 21이 됨
		int num1 = 10;
		int num2 = 20;
		int num3 = 30;
