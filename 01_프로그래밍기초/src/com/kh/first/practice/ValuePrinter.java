...
/*
 * class method는 개발자가 마음대로 이름 지어도 된다. 패키지명은 하나의 단어로, 소문자로 짓는다.
 * 네이밍 규칙
 * 1. 클래스명
 *  - 대문자로 시작, 여러 개의 단어가 있을 때는 단어 앞자리마다 대문자로 표기한다. (카멜 케이스, 낙타 표기법, 관습적 사용)
 * 2. 메소드명
 *  - 소문자로 시작, 여러 개의 단어가 있을 때는 단어 앞자리마다 대문자로 표기한다. (카멜 케이스, 낙타 표기법, 관습적 사용)
 */
...
public class ValuePrinter {
	...
	public void printTest() {
		...
		// 각 문자마다 컴퓨터가 인식하는 고유한 숫자값을 가지고 있다.(ex. 유니코드의 값 : A = 65 b = 98)
